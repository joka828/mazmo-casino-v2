...
export const CONNECTION_STRING =
  process.env.DB_HOST === "localhost"
    ? `mongodb://${process.env.DB_USER}:${process.env.DB_PASSWORD}@${process.env.DB_HOST}/${process.env.DB_NAME}?authSource=${process.env.DB_NAME}&retryWrites=true&w=majority`
